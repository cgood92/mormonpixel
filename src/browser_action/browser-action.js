(function(){
	...
	function loadImage(width, height, option, random){
		...
		copyMessageDisplay();
		pixelElem.innerHTML = '<center><img src="' + link + '" width="' + width + '" height="' + height + '"></center> <br /> <input style="display: none" id="imgLink" value="' + displaylink + '" readonly><p id="linkText">' + displaylink + '</p>';
		copyLink();
	}
